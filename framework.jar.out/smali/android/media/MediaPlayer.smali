...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Landroid/media/MediaPlayer;->mPrompt:Lcom/mediatek/common/drm/ISecureWarningPrompt;

    iput-object v1, p0, Landroid/media/MediaPlayer;->mContext:Landroid/content/Context;

    iput-object v1, p0, Landroid/media/MediaPlayer;->mWfdReceiver:Landroid/content/BroadcastReceiver;

    iput v2, p0, Landroid/media/MediaPlayer;->mSourceType:I

    iput-boolean v2, p0, Landroid/media/MediaPlayer;->mWfdConnected:Z
...
.method static synthetic access$1300(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnDurationUpdateListener;
    .locals 1
    .parameter "x0"
...
.method private initSecureFlag()V
    ...
    const-string v5, "initSecureFlag() mSourceType: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Landroid/media/MediaPlayer;->mSourceType:I

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, " mWfdReceiver: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, p0, Landroid/media/MediaPlayer;->mWfdReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget v3, p0, Landroid/media/MediaPlayer;->mSourceType:I
    ...
    :try_start_0
    const-class v3, Lcom/mediatek/common/drm/ISecureWarningPrompt;
    ...
    check-cast v3, Lcom/mediatek/common/drm/ISecureWarningPrompt;

    iput-object v3, p0, Landroid/media/MediaPlayer;->mPrompt:Lcom/mediatek/common/drm/ISecureWarningPrompt;

    new-instance v3, Landroid/media/MediaPlayer$WfdBroadcastReceiver;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Landroid/media/MediaPlayer$WfdBroadcastReceiver;-><init>(Landroid/media/MediaPlayer;Landroid/media/MediaPlayer$1;)V
    ...
    const-string v3, "com.mediatek.wfd.connection"
    ...
    const-string v3, "com.mediatek.mediaplayer.DRM_PLAY"
...
.method public pause()V
    ...
    const-string v3, "pause() mSourceType: "
    ...
    iget-boolean v1, p0, Landroid/media/MediaPlayer;->mWfdConnected:Z

    if-eqz v1, :cond_0

    iget v1, p0, Landroid/media/MediaPlayer;->mSourceType:I
    ...
    const-string v1, "com.mediatek.mediaplayer.DRM_PLAY"
...
.method public release()V
    ...
    const-string v3, "release() mWfdReceiver: "
    ...
    iput-object v4, p0, Landroid/media/MediaPlayer;->mWfdReceiver:Landroid/content/BroadcastReceiver;

    iput-object v4, p0, Landroid/media/MediaPlayer;->mPrompt:Lcom/mediatek/common/drm/ISecureWarningPrompt;
    ...
    .end local v0           #intent:Landroid/content/Intent;
    :cond_0
    iput v5, p0, Landroid/media/MediaPlayer;->mSourceType:I
    ...
    iput-object v4, p0, Landroid/media/MediaPlayer;->mOnDurationUpdateListener:Landroid/media/MediaPlayer$OnDurationUpdateListener;
...
.method public reset()V
    ...
    const-string v3, "reset() mWfdReceiver: "
    ...
    iput-object v5, p0, Landroid/media/MediaPlayer;->mWfdReceiver:Landroid/content/BroadcastReceiver;

    iput-object v5, p0, Landroid/media/MediaPlayer;->mPrompt:Lcom/mediatek/common/drm/ISecureWarningPrompt;
    ...
    .end local v0           #intent:Landroid/content/Intent;
    :cond_0
    iput v4, p0, Landroid/media/MediaPlayer;->mSourceType:I

    invoke-direct {p0}, Landroid/media/MediaPlayer;->_reset()V

    iget-object v1, p0, Landroid/media/MediaPlayer;->mEventHandler:Landroid/media/MediaPlayer$EventHandler;

    invoke-virtual {v1, v5}, Landroid/media/MediaPlayer$EventHandler;->removeCallbacksAndMessages(Ljava/lang/Object;)V
...
.method public start()V
    ...
    const-string v2, "start() mSourceType: "
