...
CUSTOM_KERNEL_GYROSCOPE = l3g4200d mpu6050c
CUSTOM_KERNEL_HDMI = 
CUSTOM_KERNEL_HEADSET = accdet
CUSTOM_KERNEL_IMGSENSOR = ms2r_yuv ov2722_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = JDI_HD_ACX457AKP
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = ms2r_yuv
...
CUSTOM_KERNEL_TOUCHPANEL = syna_truly_black synaptics_s3202_13015
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_LK_LCM = JDI_HD_ACX457AKP
CUSTOM_MODEM = OPPO89W_hspa_13025
CUSTOM_PRELOADER_CUSTOM = custom
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = JDI_HD_ACX457AKP
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = R819OR_11_1.01_130909
MTK_BWC_SUPPORT = yes
...
MTK_PRODUCT_LOCALES = en_US ar_IL da_DK de_DE el_GR es_ES fr_FR in_ID it_IT ja_JP nl_NL nb_NO pt_PT ru_RU sv_SE th_TH tr_TR vi_VN zh_CN zh_HK zh_TW hdpi mdpi ldpi xhdpi
...
OPPO_APE_PLAYBACK_SUPPORT = yes
OPPO_BREATH_LIGHT_SUPPORT = no
OPPO_BUILD_VARIANT_USER = yes
OPPO_CAMFLASH_SUPPORT = yes
OPPO_CAMFOCUS_SUPPORT = yes
OPPO_CMCC_TEST = no
OPPO_CUSTOMIZED_SETTINGS = no
OPPO_DEVICE_INTERNALSTORAGE = no
OPPO_DIRAC_SUPPORT = yes
OPPO_DOLBY_SUPPORT = yes
OPPO_EMMC_DYNAMICMOUNT_SUPPORT = no
OPPO_EXTERNAL_STORAGE_SUPPORT = yes
OPPO_EXT_ISP_MS2R = yes
OPPO_FIND_STYLE_SUPPORT = no
OPPO_FLAC_PLAYBACK_SUPPORT = yes
OPPO_FLASH_LIGHT_SUPPORT = no
OPPO_FRONTCAM_SUPPORT = yes
OPPO_GSENSOR_BMA250_SUPPORT = no
OPPO_INTERNAL_STORAGE_SUPPORT = yes
OPPO_LAUNCHER_TRASH_ANIM = no
OPPO_LOCKSCREEN_BUBBLE_SUPPORT = no
OPPO_MOTION_SENSITIVE_GSENSOR = yes
OPPO_MOV_PLAYBACK_SUPPORT = no
OPPO_MSENSOR_SUPPORT = yes
OPPO_NAVIGATIONBAR_SUPPORT = no
OPPO_OPEN_AGC_SUPPORT = yes
OPPO_PHISICAL_KEY_SUPPORT = no
OPPO_REAL_PLAYBACK_SUPPORT = yes
OPPO_REAL_SERIAL_NUMBER = yes
OPPO_REAL_STYLE_SUPPORT = yes
OPPO_ROTATE_LOCKSCREEN_SUPPORT = no
OPPO_SCREENSHOT_SUPPORT = yes
OPPO_SENSOR_HAL_ST_SUPPORT = yes
OPPO_SHORT_PRESS_DISABLE_ALARM_SUPPORT = yes
OPPO_SINGLE_SCREEN_WALLPAPER_SUPPORT = yes
OPPO_THEME_SWITCH_SUPPORT = yes
OPPO_ULIKE_SERIAL_NUMBER = no
OPPO_ULIKE_STYLE_SUPPORT = no
OPPO_VIDEO_1080P = no
OPPO_WEBVIEW_GIF_SUPPORT = yes
OPPO_WIFI_DIRECT_SUPPORT = no
OPPO_WOLFSON_CODEC_SUPPORT = yes
